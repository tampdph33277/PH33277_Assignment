            ...
            <View style={{
              ...
              <View style={{ width:'100%',height:'70%', flexDirection: 'row', justifyContent: 'space-between' }}>
                ...
                <View style={{ flexDirection: 'column', justifyContent: 'space-between',width:'35%' }}>
                  ...
                  <Image  style={{width: 20, height: 25,tintColor: '#d17842' }}  source={require('../img/cf.png')}/>    
                  <Text style={{color:'#aeaeae',fontSize:10}}>Coffee</Text>
                  </View>
                  <View style={{ backgroundColor:'#141921',width: 45, height: 45,alignItems:'center',justifyContent:'center' ,borderRadius:10}}>
                <Image  style={{width: 20, height: 25,tintColor: '#D17842' }}  source={require('../img/add.png')}/>    
        ...
        <View style={{paddingLeft:20,paddingRight:20,
          ...
          <View style={{
            ...
            <TouchableOpacity
              ...
              onPress={() => handleSizeClick('250gm')}>
              <Text style={[styles.sizeText, selectedSize === '250gm' && styles.selectedSizeText]}>250gm</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.sizeButton,
              ...
              onPress={() => handleSizeClick('500gm')}>
              <Text style={[styles.sizeText, selectedSize === '500gm' && styles.selectedSizeText]}>500gm</Text>
            </TouchableOpacity>
            <TouchableOpacity
              style={[
                styles.sizeButton,
              ...
              onPress={() => handleSizeClick('1000gm')}>
              <Text style={[styles.sizeText, selectedSize === '1000gm' && styles.selectedSizeText]}>1000gm</Text>
            </TouchableOpacity>
          </View>
        </View>
        <View style={{
